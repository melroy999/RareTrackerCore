...
L["<%s> %s seen alive (combat log)"] = "<%s> %s 还活着 (combat log)"
...
L["<%s> Please target a non-player entity prior to resetting, such that the addon can determine the current shard id."] = "<%s> 重置之前请选中一个非玩家目标, 这样插件可用确定当前的共享ID."
